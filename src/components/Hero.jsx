...
export default function Hero() {
    return (
        <div className='flex flex-col md:flex-row container mx-auto lg:mt-32 items-center'>
            ...
            <div className='w-full md:w-1/2'>
                <img className='rounded-xl hover:cursor-pointer md:hover:blur-md lg:hover:blur-lg transition-all duration-1000 lg:ms-10' src={sodiq} alt="Nimadir xato letdi" />
            </div>
        </div>
    )
}
